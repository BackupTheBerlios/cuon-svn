...
class proposalwindow(orderwindow):
    ...
    def __init__(self, allTables, dicOrder=None,  newOrder = False, orderid = 0,Ordertype='Proposal'):
        ...
        self.EntriesOrderPosition = 'proposal_position.xml'
        #self.EntriesOrderMisc = 'proposal_misc.xml'
        self.EntriesOrderInvoice = 'proposal_invoice.xml'
        #self.EntriesOrderPayment = 'proposal_inpayment.xml'
        ...
        self.singleOrderSupply.setEntries(self.getDataEntries(self.EntriesOrderSupply) )
        ...
        self.singleOrderGet.setEntries(self.getDataEntries(self.EntriesOrderGet) )
