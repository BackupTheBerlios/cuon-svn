...
static GnomeUIInfo mi_vat1_menu_uiinfo[] =
{
  {
    GNOME_APP_UI_ITEM, N_("New "),
    NULL,
    (gpointer) on_VatNew1_activate, NULL, NULL,
  ...
  },
  {
    ...
    NULL,
    (gpointer) on_VatEdit1_activate, NULL, NULL,
  ...
  },
  {
    ...
    NULL,
    (gpointer) on_VatSave1_activate, NULL, NULL,
  ...
  GNOMEUIINFO_SEPARATOR,
  {
    ...
    NULL,
    (gpointer) on_VatPrint1_activate, NULL, NULL,
  ...
  GNOMEUIINFO_SEPARATOR,
  {
    ...
    NULL,
    (gpointer) on_VatClear1_activate, NULL, NULL,
...
create_PreferencesFinancesMainwindow (void)
{
  ...
  gtk_table_attach (GTK_TABLE (table1), entry26, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  entry27 = gtk_entry_new ();
  gtk_widget_show (entry27);
  gtk_table_attach (GTK_TABLE (table1), entry27, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  entry28 = gtk_entry_new ();
  gtk_widget_show (entry28);
  gtk_table_attach (GTK_TABLE (table1), entry28, 1, 2, 2, 3,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  entry29 = gtk_entry_new ();
  gtk_widget_show (entry29);
  gtk_table_attach (GTK_TABLE (table1), entry29, 1, 2, 3, 4,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  GLADE_HOOKUP_OBJECT (PreferencesFinancesMainwindow, menubar1_uiinfo[0].widget, "file1");
  GLADE_HOOKUP_OBJECT (PreferencesFinancesMainwindow, file1_menu_uiinfo[0].widget, "choosePrinter1");
  GLADE_HOOKUP_OBJECT (PreferencesFinancesMainwindow, file1_menu_uiinfo[1].widget, "separator2");
  GLADE_HOOKUP_OBJECT (PreferencesFinancesMainwindow, file1_menu_uiinfo[2].widget, "quit1");
  GLADE_HOOKUP_OBJECT (PreferencesFinancesMainwindow, menubar1_uiinfo[1].widget, "mi_vat1");
  GLADE_HOOKUP_OBJECT (PreferencesFinancesMainwindow, mi_vat1_menu_uiinfo[0].widget, "new1");
  GLADE_HOOKUP_OBJECT (PreferencesFinancesMainwindow, mi_vat1_menu_uiinfo[1].widget, "edit1");
  GLADE_HOOKUP_OBJECT (PreferencesFinancesMainwindow, mi_vat1_menu_uiinfo[2].widget, "save1");
  GLADE_HOOKUP_OBJECT (PreferencesFinancesMainwindow, mi_vat1_menu_uiinfo[3].widget, "separator3");
  ...
  GLADE_HOOKUP_OBJECT (PreferencesFinancesMainwindow, entry26, "entry26");
  GLADE_HOOKUP_OBJECT (PreferencesFinancesMainwindow, entry27, "entry27");
