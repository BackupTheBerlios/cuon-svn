...
create_OrderMainwindow (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), eDesignation, 432, 8);
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), eDeliveredAt, 144, 88);
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), lNumber, 16, 8);
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), lDeliveredAt, 16, 88);
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), lDesignation, 336, 8);
