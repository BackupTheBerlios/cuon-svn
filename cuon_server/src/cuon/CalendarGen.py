...
# -*- coding: utf-8 -*-
#
#   PyCalendarGen.py - Copyright (C) 2005, 2006 Johan Wärlander
#
...
def usage():
    ...
    print
    print """PyCalendarGen 0.9.2, Copyright (C) 2005, 2006 Johan Warlander
