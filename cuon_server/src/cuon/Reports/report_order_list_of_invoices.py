...
##                        
            ...
            print 'ReportPath = ', reportDefs['ReportPath'] + '/order_list_of_invoices.xml'
            ...
            # 4 dicReportData
            # 5 reportDefs
        return reportDefs['ReportPath'] + '/order_list_of_invoices.xml', dicUser, self.dicResults, self.dicReportData, reportDefs
