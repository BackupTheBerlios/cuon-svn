...
class report_hibernation_invoice(report_basics):
    def __init__(self):
        ...
        self.dicReportData['Title'] = _('Hibernation Invoice generatet by CUON')
        ...
        self.dicReportData['lInvoiceNumber'] = _('Invoice-Nr.:')
    ...
    def getReportData(self, dicOrder, dicUser, oGarden, reportDefs ):
        ...
        self.fileName = reportDefs['DocumentPathHibernationInvoice'] + '/' +_('Invoice-') + `dicOrder['invoiceNumber']` + '.pdf' 
        ...
        # 4 dicReportData
        # 5 reportDefs
        return reportDefs['ReportPath'] + '/hibernation_invoice_document.xml', dicUser, self.dicResults, self.dicReportData, reportDefs
