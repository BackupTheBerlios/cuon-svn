...
class report_list_of_reminder(report_basics):
    def __init__(self):
        ...
        self.dicReportData['Title'] = _('List of Reminder generated by CUON')
    ...
    def getReportData(self, dicExtraData, dicUser, oOrder, reportDefs ):
        ...
        self.fileName = reportDefs['DocumentPathOrderInvoice'] + '/' +_('ListOfReminder-') + `dicExtraData['dBegin']`  + '.pdf' 
...
##                        
            ...
            self.dicResults['listOfReminder'] = dicResult   
            print self.dicResults
            
            print 'ReportPath = ', reportDefs['ReportPath'] + '/list_list_of_reminder.xml'
            ...
            # 4 dicReportData
            # 5 reportDefs
        return reportDefs['ReportPath'] + '/list_of_reminder.xml', dicUser, self.dicResults, self.dicReportData, reportDefs
