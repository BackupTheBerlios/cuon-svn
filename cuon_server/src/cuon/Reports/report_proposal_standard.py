...
class report_proposal_standard(report_basics):
    def __init__(self):
    ...
    def getReportData(self, dicOrder, dicUser, oOrder, reportDefs ):
        ...
        print "---- start Proposal Rep"
        self.fileName = reportDefs['DocumentPathOrderProposal'] + '/' +_('Proposal-') + `dicOrder['proposalNumber']` + '.pdf' 
        print self.fileName
...
##    
            ...
            # 4 dicReportData
            # 5 reportDefs
        return reportDefs['ReportPath'] + '/order_standardproposal.xml', dicUser, self.dicResults, self.dicReportData, reportDefs
