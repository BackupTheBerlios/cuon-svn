...
class report_addresses_phone12:
    def __init__(self):
        self.dicReportData = {}
    ...
    def getReportData(self, dicSearchfields, dicUser, oAddress, reportDefs):
        self.dicResults = {}
        self.fileName = reportDefs['DocumentPathListsAddresses'] + '/' +_('Addresslist12-') + `dicUser['Name']` + '.pdf' 
        reportDefs['pdfFile'] = os.path.normpath(self.fileName)
        
        dicResult =  oAddress.getPhonelist12( dicSearchfields, dicUser)
        ...
        # 4 dicReportData
        # 5 reportDefs
        return reportDefs['ReportPath'] + '/addresses_phonelist12.xml', dicUser, self.dicResults, self.dicReportData, reportDefs
