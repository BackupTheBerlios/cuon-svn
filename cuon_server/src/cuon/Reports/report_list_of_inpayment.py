...
class report_list_of_inpayment(report_basics):
    def __init__(self):
    ...
    def getReportData(self, dicExtraData, dicUser, oOrder, reportDefs ):
        ...
        self.fileName = reportDefs['DocumentPathOrderInvoice'] + '/' +_('ListOfInpayment-') + `dicExtraData['dBegin']` + '-' + `dicExtraData['dEnd']` + '.pdf' 
...
##                        
            ...
            self.dicResults['listOfInpayment'] = dicResult   
            print self.dicResults
            
            print 'ReportPath = ', reportDefs['ReportPath'] + '/list_of_inpayment.xml'
            ...
            # 4 dicReportData
            # 5 reportDefs
        return reportDefs['ReportPath'] + '/list_of_inpayment.xml', dicUser, self.dicResults, self.dicReportData, reportDefs
